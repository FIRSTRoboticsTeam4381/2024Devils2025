...
public final class Constants {
    ...
    public static final class Swerve{
        ...
        public static final double driveKP = 0.00008; //From SysID, may not be converted right!
        ...
        public static final double driveKS = 0.044345;//(0.667 / 12); // divide by 122 to convert from volts to percent output for CTRE TODO?
        public static final double driveKV = 2.1441;//(2.44 / 12);
        public static final double driveKA = 0.55957;//(0.27 / 12);
